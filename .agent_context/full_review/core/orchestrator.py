...
class Orchestrator:
    ...
    def _register_agents(self):
        self.registry = {
            "smart_cleaner": SmartCleaner(self.config, self.db),
            "ghost_audit": GhostAudit(self.config, self.db),
            "verifier_agent": VerifierAgent(self.config, self.db),
            "socialmedia_agent": SocialMediaAgent(self.config, self.db),
            "seo_agent": SEOAgent(self.config, self.db),
            "ledger_agent": LedgerAgent(self.config, self.db),
            "registry_agent": RegistryAgent(self.config, self.db),
            "validation_grader": ValidationGrader(self.config, None, self.db),
            "narrative_grader": NarrativeGrader(self.config, None, self.db),
        }
